...
# --- EPyMARL MultiAgentEnv base class (always available) ---
...
# --- StarCraft II (optional — requires smac + SC2 binary) ---
try:
    from smac.env import MultiAgentEnv as SmacMultiAgentEnv, StarCraft2Env
...
# --- IMP-MARL (optional — requires imp_marl package) ---
try:
...
# --- MAgent environments (optional — requires pettingzoo[magent], supersuit) ---
try:
    import pretrained
    from .adv_pursuit_wrappers import AdvPursuit_w_PretrainedOpp
    from .battle_wrappers import Battle_w_PretrainedOpp
...
try:
    ...
    REGISTRY["MPE_Spread"] = partial(env_fn, env=MPEWrapper)
except ImportError:
    pass


# --- GymMA wrapper (optional — requires gym==0.21) ---
try:
    import gym
